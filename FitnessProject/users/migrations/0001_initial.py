    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Admin'), ('REGISTERED', 'Registered')], default='REGISTERED', max_length=10)),
                ...
                ('subscription_plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='subscriptions.dimsubscriptionplan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.dimcontactinfo')),
            ],
            options={
